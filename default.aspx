    ...
    <div class="services container">
        ...
        <div class="row">
            <section class="col-xs-offset-3 col-xs-6 col-sm-offset-0 col-sm-6
                 col-md-4  ">
               <a  href="Add.aspx" style="color: #000000"> <img src="images/Addicon.png" alt="icon" style="height: 179px; width: 184px; margin-right: 0px;"/>
            ...
            <div class="services container">
                <section class="col-xs-offset-3 col-xs-6 col-sm-offset-0 col-sm-6 col-md-4 ">
                 <a href="Search.aspx" style="color: black" >   <img src="images/Searchicon.png" alt="icon" style="height: 179px; width: 184px;"/>
                    <div class="col-xs-offset-1 col-sm-offset-0">
                        <h3>Search Recipe</h3>
                        <p >
                ...
                <div class="services container">
                    <section class="col-xs-offset-3 col-xs-6 col-sm-offset-0  col-sm-12 col-md-4 ">
                      <a href="Recipes.aspx" style="color: #000000">  <img src="images/Listicon.png" alt="icon" style="height: 179px; width: 184px;"/>
                        <div class="col-xs-offset-1 col-sm-offset-0">
